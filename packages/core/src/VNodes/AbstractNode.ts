...
import { tangibleWalker } from '../Walker';
...
export abstract class AbstractNode extends EventMixin {
    ...
    get parent(): ContainerNode {
        return tangibleWalker.parent(this as VNode);
    }
    /**
     ...
     */
    get length(): number {
        return tangibleWalker.children(this as VNode).length;
    }
    /**
     * See {@link Walker.testPredicate}.
     */
    test(predicate?: Predicate): boolean {
        return tangibleWalker.test(this as VNode, predicate);
    }
    /**
     * See {@link Walker.isBefore}.
     */
    isBefore(vNode: VNode): boolean {
        return tangibleWalker.isBefore(this as VNode, vNode);
    }
    /**
     * See {@link Walker.isAfter}.
     */
    isAfter(vNode: VNode): boolean {
        return tangibleWalker.isAfter(this as VNode, vNode);
    }
    ...
    closest(predicate: Predicate): VNode {
        return tangibleWalker.closest(this as VNode, predicate);
    }
    /**
    ...
    ancestor(predicate?: Predicate): ContainerNode {
        return tangibleWalker.ancestor(this as VNode, predicate);
    }
    /**
    ...
    ancestors(predicate?: Predicate): ContainerNode[] {
        return tangibleWalker.ancestors(this as VNode, predicate);
    }
    /**
    ...
    commonAncestor(node: VNode, predicate?: Predicate): ContainerNode {
        return tangibleWalker.commonAncestor(this as VNode, node, predicate);
    }
    /**
    ...
    siblings(predicate?: Predicate): VNode[] {
        return tangibleWalker.siblings(this as VNode, predicate);
    }
    /**
    ...
    adjacents(predicate?: Predicate): VNode[] {
        return tangibleWalker.adjacents(this as VNode, predicate);
    }
    /**
    ...
    previousSibling(predicate?: Predicate): VNode {
        return tangibleWalker.previousSibling(this as VNode, predicate);
    }
    /**
    ...
    nextSibling(predicate?: Predicate): VNode {
        return tangibleWalker.nextSibling(this as VNode, predicate);
    }
    /**
    ...
    previous(predicate?: Predicate): VNode {
        return tangibleWalker.previous(this as VNode, predicate);
    }
    /**
    ...
    next(predicate?: Predicate): VNode {
        return tangibleWalker.next(this as VNode, predicate);
    }
    /**
    ...
    previousLeaf(predicate?: Predicate): VNode {
        return tangibleWalker.previousLeaf(this as VNode, predicate);
    }
    /**
    ...
    nextLeaf(predicate?: Predicate): VNode {
        return tangibleWalker.nextLeaf(this as VNode, predicate);
    }
    /**
    ...
    previousSiblings(predicate?: Predicate): VNode[] {
        return tangibleWalker.previousSiblings(this as VNode, predicate);
    }
    /**
    ...
    nextSiblings(predicate?: Predicate): VNode[] {
        return tangibleWalker.nextSiblings(this as VNode, predicate);
    }
    ...
    children(predicate?: Predicate): VNode[] {
        return tangibleWalker.children(this as VNode, predicate);
    }
    /**
     * See {@link Walker.hasChildren}.
     */
    hasChildren(): boolean {
        return tangibleWalker.hasChildren(this);
    }
    /**
     * See {@link Walker.nthChild}.
     */
    nthChild(n: number): VNode {
        return tangibleWalker.nthChild(this, n);
    }
    /**
    ...
    firstChild(predicate?: Predicate): VNode {
        return tangibleWalker.firstChild(this as VNode, predicate);
    }
    /**
    ...
    lastChild(predicate?: Predicate): VNode {
        return tangibleWalker.lastChild(this as VNode, predicate);
    }
    /**
    ...
    firstLeaf(predicate?: Predicate): VNode {
        return tangibleWalker.firstLeaf(this as VNode, predicate);
    }
    /**
    ...
    lastLeaf(predicate?: Predicate): VNode {
        return tangibleWalker.lastLeaf(this as VNode, predicate);
    }
    /**
    ...
    descendants(predicate?: Predicate): VNode[] {
        return tangibleWalker.descendants(this as VNode, predicate);
    }
    ...
    firstDescendant(predicate?: Predicate): VNode {
        return tangibleWalker.firstDescendant(this as VNode, predicate);
    }
    /**
    ...
    lastDescendant(predicate?: Predicate): VNode {
        return tangibleWalker.lastDescendant(this as VNode, predicate);
    }
    //--------------------------------------------------------------------------
